...
while cap.isOpened():
    ...
    if (shoot_again_count < 101):
        ...
        cv2.putText(frame1, "{}".format('Ready'), (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 3)
 ...
 #   cv2.rectangle(frame1, (x, y), (x+w, y+h), (0, 255, 0), 2)
    ...
    if ((aim == False) and ((y < (frame_height * 3.0/ 8.0) and (y > (frame_height * 1.0 / 8.0)))) and (shoot_again_count > 100)):
        cv2.putText(frame1, "{}".format('AIM'), (10, 20), cv2.FONT_HERSHEY_SIMPLEX,
                1, (0, 0, 255), 3)
    ...
    if (aim and ((y) < (frame_height * 1.0/ 8.0)) and (shoot_again_count > 100)):
        cv2.putText(frame1, "{}".format('Shoot'), (10, 40), cv2.FONT_HERSHEY_SIMPLEX,
                1, (0, 0, 255), 3)
        if (shoot_count < 3):
